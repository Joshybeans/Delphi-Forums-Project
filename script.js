...
let questions = [
    ...
    'What year was Kussmaul Encyclopedia established in?\nA) 1982\nB) 1990\nC) 1980\nD) 1981\n',
...
function process(deltaTime) {
    ...
    gameItems[1].position = new Vector2((canvas.width - gameItems[1].size.x) / 2, (canvas.height - gameItems[1].size.y) / 2 - 175);
